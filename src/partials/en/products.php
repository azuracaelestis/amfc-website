	...
	<div class="container text-center">
		...
		<div class="amfc-en-products__grid">
			<div class="amfc-en-product-card">
				<img src="<?= e(asset('images/en/product-vehicle-loan.png')) ?>" alt="Vehicle loan illustration" width="1024" height="1536" />
				<p class="amfc-en-product-card__label">Vehicle Loan</p>
			</div>
			<div class="amfc-en-product-card">
				<img src="<?= e(asset('images/en/product-personal-loan.png')) ?>" alt="Personal loan illustration" width="1024" height="1536" />
				<p class="amfc-en-product-card__label">Personal Loan</p>
			</div>
			<div class="amfc-en-product-card">
				<img src="<?= e(asset('images/en/product-buddyloan.png')) ?>" alt="BuddyLoan illustration" width="930" height="532" />
				<p class="amfc-en-product-card__label">BuddyLoan</p>
			</div>
			<div class="amfc-en-product-card">
				<img src="<?= e(asset('images/en/product-corporate-bond.png')) ?>" alt="Corporate bond illustration" width="1024" height="1536" />
